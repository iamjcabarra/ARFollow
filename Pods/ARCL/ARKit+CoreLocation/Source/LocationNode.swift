...
open class LocationAnnotationNode: LocationNode {
    ...
    public init(location: CLLocation?, image: UIImage, isStep: Bool) {
        self.image = image
        ...
        if isStep {
            ...
            let box = SCNBox(width: image.size.width / 200, height: image.size.height / 200, length: 1, chamferRadius: 0.25)
