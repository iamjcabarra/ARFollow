...
struct ARFConstants {
    ...
    struct color {
        static let GAV_NAV_DASHBOARD: UIColor = UIColor(hex: "602320")
        static let GAV_NAV_USR_MOD: UIColor = UIColor(hex: "D01110")
        static let GAV_NAV_CRS_MOD: UIColor = UIColor(hex: "0458AB")
        static let GAV_NAV_CLA_MOD: UIColor = UIColor(hex: "116530")
        static let GCV_NAV_DASHBOARD: UIColor = UIColor(hex: "400080")
        static let GCV_NAV_CLU_MOD: UIColor = UIColor(hex: "D01110")
        static let GCV_NAV_TRE_MOD: UIColor = UIColor(hex: "0458AB")
        static let GCV_NAV_GAM_MOD: UIColor = UIColor(hex: "116530")
        static let GPV_NAV_DASHBOARD: UIColor = UIColor(hex: "0458AB")
        static let GEN_CREATE_ACTION: UIColor = UIColor(hex: "008744")
        static let GEN_UPDATE_ACTION: UIColor = UIColor(hex: "dc6900")
    }
