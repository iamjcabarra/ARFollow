...
class ARFBarChart: UIView {
    ...
    func setBarChart(with dataPoints: [String], values: [String], names: [String]) {
        ...
        barChartView.backgroundColor = UIColor(hex: "FFD9CD")
        ...
        let chartDataSet = BarChartDataSet(values: dataEntry, label: "Success Rate Per Deployed Game")
        let chartData = BarChartData()
        chartData.addDataSet(chartDataSet)
        chartData.setDrawValues(false)
        chartDataSet.colors = [UIColor(hex: "602320")]
