...
class ARFGPGamePlayViewController: UIViewController, ARFLocationManagerDelegate, AVAudioPlayerDelegate, ARFGPGameClueViewControllerDelegate, ARFGPGameTreasureViewControllerDelegate, ARFGPGamePauseViewControllerDelegate, ARFGPGameMapViewControllerDelegate, ARFGPGamePlayResultViewControllerDelegate {
    ...
    fileprivate func loadStartingClue() {
        ...
        if let sgc = self.arfDataManager.db.retrieveObject(forEntity: entityGameClue, filteredBy: predicateC) as? GameClue {
            ...
            let message = "Sorry, you can't start the game as its starting clue was not configured properly."
    ...
    fileprivate func loadSceneView(_ longitude: Double, latitude: Double) {
        ...
        let frDestinationLocationNode = LocationAnnotationNode(location: frDestinationLocation, image: frDestinationImage, isStep: true)
        ...
        self.arfLocationManager.getPolylineRoutes(from: fromLocation, to: toLocation) { (result) in
            ...
            if let r = result, let routes = r["routes"] as? [[String: Any]] {
               for route in routes {
                    ...
                    let startLocationNode = LocationAnnotationNode(location: startLocation, image: startImage, isStep: true)
                    ...
                    let endLocationNode = LocationAnnotationNode(location: endLocation, image: endImage, isStep: true)
            ...
            let toDestinationLocationNode = LocationAnnotationNode(location: toDestinationLocation, image: toDestinationImage, isStep: false)
