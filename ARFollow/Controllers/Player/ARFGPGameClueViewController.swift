...
class ARFGPGameClueViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate {
    ...
    fileprivate var wrongMessages = ["Incorrect", "Wrong", "Mistaken", "No luck", "I'm Sorry"]
    ...
    override func viewDidLoad() {
        ...
        self.messageLabel.text = "Congratulations! You just answered the riddle correctly!"
        self.clueLabel.text = self.gameClue.clue ?? ""
        
        /// Configure proceed button
        let title = self.isLast ? "Find Treasure" : "Find Next Clue"
