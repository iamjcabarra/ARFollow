...
class ARFGAUserCreationViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate, ARFGAUserTypePopoverDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.navigationBar.topItem?.title = self.isCreation ? "Create User" : "Update User"
    ...
    fileprivate func renderData() {
        if self.user != nil {
            self.userTypeTextField.text = self.user.type == 0 ? "Administrator" : self.user.type == 1 ? "Creator" : "Player"
    ...
    @objc fileprivate func cancelButtonAction(_ sender: UIButton) {
        ...
        let message = "Are you sure you want to cancel \(action) this user?"
    ...
    @objc fileprivate func processButtonAction(_ sender: UIButton) {
        let title = self.isCreation ? "Create User" : "Update User"
        ...
        let rfKeys = ["lastName", "firstName", "middleName", "gender", "birthdate", "address", "mobile", "email", "type", "username", "encryptedUsername", "password", "encryptedPassword", "owner"]
